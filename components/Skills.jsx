...
const skillsData = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Power BI", icon: <img src="https://img.icons8.com/fluency/48/power-bi-2021.png" alt="Power BI" className="w-8 h-8 md:w-10 md:h-10" /> },
      { name: "Seaborn", icon: <img src="https://seaborn.pydata.org/_static/logo-mark-lightbg.svg" alt="Seaborn" className="w-8 h-8 md:w-10 md:h-10" /> }
    ]
  },
  {
